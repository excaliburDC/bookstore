		...
		<div class="post">
			...
			<div class="entry">
				<?php
						if(isset($_GET['ok']))
						{
							echo '<font color="blue">Category added successfully...</font>';
							echo '<br><br>';
						}
				?>
				...
				<?php
						if(isset($_GET['c']))
						{
							echo '<font color="blue">Sub-Category added successfully...</font>';
							echo '<br><br>';
						}
				?>
				...
				<?php
						if(isset($_GET['a']))
						{
							echo '<font color="blue">Category deleted successfully...</font>';
							echo '<br><br>';
						}
				?>
				...
				<?php
						if(isset($_GET['b']))
						{
							echo '<font color="blue">Sub-Category deleted successfully...</font>';
							echo '<br><br>';
						}
				?>
